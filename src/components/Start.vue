...
<<<<<<< HEAD
                                ...
                                <div class="prizes">
                                    <h4>1st Prize&nbsp;&nbsp;&nbsp;&nbsp;Three Course Sunday Lunch for Two at the
                                        Michelin-Starred Ritz Restaurant</h4>
                                    <h4>2nd Prize&nbsp;&nbsp;&nbsp;&nbsp;Champagne Cinema Evening for Two at the 5*
                                        Luxury Courthouse Hotel</h4>
=======
                                <!--div class="prizes">
...
>>>>>>> 68b9024d0e96226108d35d72eab869643b1ea8c6
                                ...
                                <div id="children">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr v-for="(score, index) in scores" v-if="index < 10">
                                            <td><strong style="font-family:'giorgiosans-bolditalic'">{{index+1}}{{index+1
                                                | pluralize('st','nd','rd','th')}}</strong></td>
                                            <td style="font-family:'gotham-book'; font-weight:normal; font-style:normal; text-transform:uppercase;">
                                                {{score.initial_name}}
                                            </td>
                                            <td><strong style="font-family:'giorgiosans-bolditalic'">{{score.time.minutes}}:{{score.time.seconds
                                                < 10 ? '0'+score.time.seconds : score.time.seconds}}</strong></td>
                                            <td><strong style="font-family:'giorgiosans-bolditalic'">{{score.correct_answers}}/10</strong>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                ...
                <section class="pos-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-10">
                                <p class="text-left">Test your knowledge of the world of social by answering 10
                                    questions as quick as you can to see if you have what it takes to become a social
                                    media expert.</p>
                            </div>
                        </div>
                    </div>
